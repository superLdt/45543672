...
| 车辆容积管理 | 获取车辆容积参考数据 | GET | /api/dispatch/vehicle-capacity | 获取车辆容积参考数据(分页) | ✅ 已实现 |
| 车辆容积管理 | 更新或插入车辆容积参考数据 | POST | /api/dispatch/vehicle-capacity | 更新或插入车辆容积参考数据 | ✅ 已实现 |
| 车辆容积管理 | 删除车辆容积参考数据 | DELETE | /api/dispatch/vehicle-capacity/<license_plate> | 删除指定车牌号的车辆容积参考数据 | ✅ 已实现 |
